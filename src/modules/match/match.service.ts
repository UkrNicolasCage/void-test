...
import type { IGetMatchRes, IPlayerMatchesData } from './match.types'
...
export class MatchService {
    ...
    public async getMatchById(matchId: string, region: string): Promise<IGetMatchRes> {
        try {
    ...
    // public async getGamesStatistics(puuid: string, region: string, limit): Promise<any> {}
